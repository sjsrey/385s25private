...
|------|-------|-------------------------------------|-------------------|-----------------------------------------------------|
| 1    | 1-21  | Introduction                        |                   | [Prerequisite Quiz][quiz]                           |
|      | 1-23  | Jupyter                             |                   |                                                     |
| 2    | 1-28  | Labor Day (Holiday)                 |                   |                                                     |
|      | 1-30  | Pandas                              | [GDA 3][gda3]     |                                                     |
| 3    | 2-04  | Spatial Data Analysis               | [GDS 1][gds1]     |                                                     |
|      | 2-06  | Geopandas                           | [GDA 6][gda6]     |                                                     |
| 4    | 2-11  | Area Unit Data                      | [GDS 3][gds3]     |                                                     |
|      | 2-13  | Geoprocessing: Area Units           | [GDA 6][gda6]     |                                                     |
| 5    | 2-18  | Visualizing Area Unit Data          | [GDS 5][gds5]     | [Python Primer][pp]                                 |
|      | 2-20  | Choropleth Mapping                  |                   |                                                     |
| 6    | 2-25  | Spatial Weights                     | [GDS 4][gds4]     | Topic Approval                                      |
|      | 2-27 | Neighbor Relations                  |                   | Peer Evaluation 1                                   |
| 7    | 3-04 | Global Spatial Autocorrelation      | [GDS 6][gds5]     |                                                     |
|      | 3-06 | Testing for Clustering              |                   |                                                     |
| 8    | 3-11 | Local Spatial Autocorrelation       | [GDS 7][gds6]     | Project Proposal                                    |
|      | 3-13 | Cluster Detection                   |                   |                                                     |
| 9    | 3-18 | Clustering Area Unit Data           | [GDS 10][gdsreg]  |                                                     |
|      | 3-20 | Region Building                     |                   | Peer Evaluation 2                                   |
| 10   | 3-25 | Point Pattern Data                  | [GDS 8.1][gds8.1] |                                                     |
|      | 3-27 | Geoprocessing: Points               |                   |                                                     |
| 11   | 3-04 | Centrography                        | [GDS 8.2][gds8.2] | Data Visualization                                  |
|      | 11-06 | Quadrat Analysis                    |                   |                                                     |
| 12   | 11-11 | Veteran's Day (Holiday)             |                   |                                                     |
|      | 11-13 | NARSC                               |                   | Peer Evaluation 3                                   |
| 13   | 11-18 | Nearest Neighbor Tests              | [GDS 8.3][gds8.3] |                                                     |
|      | 11-20 | Project Help                        |                   | Data Analysis                                       |
| 14   | 11-25 | Distance Based Statistics           |                   |                                                     |
|      | 11-27 | Thanksgiving (Holiday)              |                   |                                                     |
| 15   | 12-02 | Distance Based Statistics           |                   |                                                     |
|      | 12-04 | Project Help                        |                   | [Studio 12 Help][s12]                               |
| 16   | 12-09 | Studio                              |                   | [Draft (12/8)][draft],  Studio 13 Peer Evaluation 4 |
|      | 12-11 | Next steps in spatial data analysis |                   |                                                     |
| 17   | 12-18 | Final Presentations (1-3pm)         |                   | Computational Notebook                              |
-->
...
|            4 | 02-11 | Proximity Relations                | [RAW 4][gds4]           |           |            3 |
|              | 02-13 | Spatial Graphs                     | [RAW 4][gds4]           |           |              |
|            5 | 02-18 | Visualization                      | [VIZ][VIZ]              | One due   |            4 |
|              | 02-20 | Geovisualization                   | [BOKGV][bokgv]          | Two out   |              |
|            6 | 02-25 | Classification Schemes             | [RAW 5][gds5]           |           |            5 |
|              | 02-27 | Choropleth Mapping                 | [RAW 5][gds5]           |           |              |
|            7 | 03-04 | Point Pattern Visualization        | [DABVPP][dabvpp]        |           |            6 |
|              | 03-06 | Kernel Density Estimation          | [DABVPP][dabvpp]        |           |            7 |
|            8 | 03-11 | Review                             |                         | Two due   |              |
|              | 03-13 | *Exam 1*                           |                         |           |              |
|            9 | 03-18 | Global Autocorrelation             | [RAW 6][gds6]           | Three out |            8 |
|              | 03-20 | Global Autocorrelation Tests       | [RAW 6][gds6]           |           |              |
|           10 | 03-25 | Local Autocorrelation              | [RAW 7][gds7]           |           |            9 |
|              | 03-27 | Local Autocorrelation Tests        | [RAW 7][gds7]           |           |              |
| Spring Break | 03-31 |                                    |                         |           |              |
|           11 | 04-08 | Nearest Neighbor Relations         | [RAW 8][gds8]           |           |           10 |
|              | 04-10 | Nearest Neighbor Tests             | [RAW 8][gds8]           |           |              |
|           12 | 04-15 | Nearest Neighbor Distances         | [RAW 8][gds8]           | Three due |           11 |
|              | 04-17 | Distance Based Tests               | [RAW 8][gds8]           | Four out  |              |
|           13 | 04-22 | Clustering Point Patterns          | [DABPC][dabpc]          |           |           12 |
|              | 04-24 | Regionalization                    | [RAW 10][gds10]         |           |              |
|           14 | 04-29 | Interpolation Point Based          | [DS6.6][ds66]           | 13        |           13 |
|              | 05-01 | Kriging                            | [DS6.7][ds67]           |           |              |
|           15 | 05-06 | Interpolation Area Based           | [DS4.2][ds42]           |           |           14 |
